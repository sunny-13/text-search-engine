...
public class TitleQueryService extends QueryService {
    ...
    private PriorityQueue<RelevancePair> calculateWordRelevance(List<FrequencyModel> frequencyModelList) {
        ...
        List<FrequencyModel> frequencyModelListWithWordInTitle = nullSafeList(frequencyModelList).stream()
        ...
        for (FrequencyModel frequencyModel : nullSafeList(frequencyModelListWithWordInTitle)) {
            ...
            Integer totalOccurrencesInDoc = frequencyModel.getTitleFrequency();
